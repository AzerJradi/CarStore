let data = [
    { id: 1, img: "../imagess/Ferrari_F8_Tributo.jpg", name: "F8 Tributo", prix: "$497,000" },
    { id: 2, img: "../imagess/Ferrari LaFerrari FXX-K Evo($2,700,000).jfif", name: "LaFerrari", prix: "$2,700,000" },
    { id: 3, img: "../imagess/Ferrari_458_Speciale.jfif", name: "Ferrari 458", prix: "$365,000" },
    { id: 4, img: "../imagess/ferrari_488_GTB.jpg", name: "ferrari 488", prix: "$250,629" },
    { id: 5, img: "../imagess/Ferrari_458_Italia.jpg", name: "458 italia", prix: "$300,000" }
];
